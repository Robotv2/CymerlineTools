...
public class ItemAPI {
    private static final CymerlineTools instance = CymerlineTools.getInstance();
    private static final HashMap<String, ItemStack> heads = new HashMap<>();
    ...
    public static class ItemBuilder {
        ...
        public ItemBuilder setName(String name) {
            this.meta.setDisplayName(ColorAPI.colorize(name));
            return this;
        }
